  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div
            className="font-mono text-[10.5px] uppercase tracking-[0.22em] text-[color:var(--slate)] mb-1"
          >
            MTTR
          </div>
          <CountUp
        ...
        <div className="flex flex-col gap-2">
          <div
            className="font-mono text-[10.5px] uppercase tracking-[0.22em] text-[color:var(--slate)]"
          >
            severity · status
          </div>
