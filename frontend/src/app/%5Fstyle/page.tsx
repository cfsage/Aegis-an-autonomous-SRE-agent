...
const palette: Array<{ name: string; value: string; note?: string }> = [
	{
		name: "ink · canvas",
		value: "oklch(13% 0.008 250)",
		note: "Cold ink with blue undertone — not pure black.",
	},
	{
		name: "ink · surface",
		value: "oklch(17% 0.010 250)",
		note: "Elevated card body.",
	},
	{
		name: "ink · elevated",
		value: "oklch(22% 0.012 250)",
		note: "Tool call inner card.",
	},
	{ name: "bone", value: "oklch(96% 0.006 80)", note: "Primary text." },
	{
		name: "oyster",
		value: "oklch(78% 0.008 80)",
		note: "Secondary text, descriptions.",
	},
	{
		name: "slate",
		value: "oklch(54% 0.010 250)",
		note: "Muted text, eyebrows.",
	},
	{
		name: "grave",
		value: "oklch(38% 0.012 250)",
		note: "Dim text, past/resolved.",
	},
	{
		name: "ember 400",
		value: "oklch(70% 0.20 35)",
		note: "PERSIMMON. Semantic accent only.",
	},
	{
		name: "ember glow",
		value: "oklch(70% 0.20 35 / 0.32)",
		note: "Outer shadow color.",
	},
	{
		name: "ice 400",
		value: "oklch(82% 0.13 200)",
		note: "Resolved / verified state only.",
	},
];
		...
		<>
			...
			<header className="surface px-6 md:px-10 py-8">
				...
				<p className="mt-4 max-w-[60ch] text-[color:var(--oyster)] text-[15px]">
					...
					Cold ink, persimmon ember, Fraunces wonky-axis serifs. Every choice on
					this page is documented as a token in{" "}
			...
			<div className="px-6 md:px-10 py-10 space-y-16">
				...
				<section aria-labelledby="type-eyebrow">
					<h2 id="type-eyebrow" className="eyebrow mb-6">
						typography
					</h2>
				...
				<section aria-labelledby="sev-eyebrow">
					<h2 id="sev-eyebrow" className="eyebrow mb-6">
						severity chips
					</h2>
				...
				<section aria-labelledby="status-eyebrow">
					<h2 id="status-eyebrow" className="eyebrow mb-6">
						status pills
					</h2>
					<div className="flex flex-wrap items-center gap-6">
				...
				<section aria-labelledby="btn-eyebrow">
					<h2 id="btn-eyebrow" className="eyebrow mb-6">
						button variants
					</h2>
				...
				<section aria-labelledby="step-eyebrow">
					<h2 id="step-eyebrow" className="eyebrow mb-6">
						agent step states
					</h2>
					<div className="surface max-w-[680px]">
						<ul>
							...
							/>
							<li className="block h-px ml-9 mr-4 bg-[color:var(--hairline-soft)]" />
							<AgentStep event={mockIncident.agentEvents[7]} state="pending" />
						</ul>
					</div>
				</section>
				...
				<section aria-labelledby="hyp-eyebrow">
					<h2 id="hyp-eyebrow" className="eyebrow mb-6">
						hypothesis card
					</h2>
				...
				<section aria-labelledby="hair-eyebrow">
					<h2 id="hair-eyebrow" className="eyebrow mb-6">
						hairline system
					</h2>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						{[160, 220, 320].map((h) => (
							<div key={h} className="surface p-4" style={{ height: h }}>
				...
				<section aria-labelledby="motion-eyebrow">
					<h2 id="motion-eyebrow" className="eyebrow mb-6">
						motion easings
					</h2>
					<p className="text-[13px] text-[color:var(--oyster)] max-w-[60ch] mb-5">
				...
				<section aria-labelledby="grain-eyebrow">
					<h2 id="grain-eyebrow" className="eyebrow mb-6">
						grain overlay
					</h2>
				...
				<section aria-labelledby="prim-eyebrow">
					<h2 id="prim-eyebrow" className="eyebrow mb-6">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<Card>
							...
							<CardBody>
								<p className="text-[13px] text-[color:var(--oyster)]">
									Used everywhere a panel is needed. 3px corners, hairline
									border, gradient top edge.
								</p>
				...
				<section aria-labelledby="atom-eyebrow">
					<h2 id="atom-eyebrow" className="eyebrow mb-6">
						atoms
					</h2>
...
function EasingDemo({ name, curve }: { name: string; curve: string }) {
	...
	const easing = parseCubic(
		curve.startsWith("cubic") ? curve : "cubic-bezier(0.22,1,0.36,1)",
	);
	return (
		<button
			type="button"
